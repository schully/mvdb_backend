...
exports.fetchMovie = function (id) { return __awaiter(_this, void 0, void 0, function () {
    var url, result, cast, categories;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                filterMovie(result);
                cast = getCast(result);
                categories = (result.Genre || "").split(",").map(function (c) { return c.trim(); });
                return [2 /*return*/, {
                        result: {
                            cast: cast,
...
function getCast(imdbMovieResut) {
    ...
    var director = fromString(imdbMovieResut.Actors);
    actors.forEach(function (worker) { return worker.role = 'director'; });
    return __assign({}, actors, director);
}
