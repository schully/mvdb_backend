...
exports.getMovies = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, dataBase_1.query(util_1.default.getQuery('movies'), null, {
                        forceArray: true,
...
exports.getImdb = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var imdbId, result, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, omdbConnection_1.fetchMovie(imdbId)];
            case 2:
                result = _a.sent();
            ...
            case 3:
                error_3 = _a.sent();
                errorHandler_1.default(res, 'server', null, error_3);
                return [3 /*break*/, 4];
